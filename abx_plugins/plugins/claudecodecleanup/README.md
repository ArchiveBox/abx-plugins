...
| `CLAUDECODECLEANUP_TIMEOUT` | int | `120` | `CLAUDECODE_TIMEOUT` | Timeout in seconds. |
| `CLAUDECODECLEANUP_MODEL` | string | `sonnet` | `CLAUDECODE_MODEL` | Claude model to use. |
| `CLAUDECODECLEANUP_MAX_TURNS` | int | `15` | `CLAUDECODE_MAX_TURNS` | Max agentic turns (higher default than extract due to more complex task). |
...
export CLAUDECODECLEANUP_MODEL=opus
