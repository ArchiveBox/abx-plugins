...
- Content: `docs/index.html.j2`.
- Site/gallery generation: `docs/generate.py`.
- Application capture: none; this site renders the current package catalog.
